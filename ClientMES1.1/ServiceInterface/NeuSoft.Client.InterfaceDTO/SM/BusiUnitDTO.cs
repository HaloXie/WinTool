...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class BusiUnitDTO
    {
        ...
        public string GROUP_GID { get => _GROUP_GID; set => _GROUP_GID = value; }
        public string BUSI_UNIT_CODE { get => _BUSI_UNIT_CODE; set => _BUSI_UNIT_CODE = value; }
        public string BUSI_UNIT_NAME { get => _BUSI_UNIT_NAME; set => _BUSI_UNIT_NAME = value; }
        ...
        public string ABBREVIATE { get => _ABBREVIATE; set => _ABBREVIATE = value; }
