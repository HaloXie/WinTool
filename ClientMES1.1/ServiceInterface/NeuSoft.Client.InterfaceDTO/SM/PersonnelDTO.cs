...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class PersonnelDTO
    {
        ...
        public decimal? SEQ { get => _SEQ; set => _SEQ = value; }
        public string PERSONNEL_CODE { get => _PERSONNEL_CODE; set => _PERSONNEL_CODE = value; }
        public string PERSONNEL_NAME { get => _PERSONNEL_NAME; set => _PERSONNEL_NAME = value; }
        public string SM_PERSONNEL_TYPE_GID { get => _SM_PERSONNEL_TYPE_GID; set => _SM_PERSONNEL_TYPE_GID = value; }
        public string SM_DEPARTMENT_GID { get => _SM_DEPARTMENT_GID; set => _SM_DEPARTMENT_GID = value; }
