...
{
    public class LogisticReceiveDTO
    {
        private string _GID;
        ...
        public string SOURCE_TYPE { get => _SOURCE_TYPE; set => _SOURCE_TYPE = value; }
        public string SOURCE_CODE { get => _SOURCE_CODE; set => _SOURCE_CODE = value; }
