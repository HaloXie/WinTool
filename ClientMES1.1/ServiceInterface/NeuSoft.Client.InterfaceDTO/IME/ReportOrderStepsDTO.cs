...
{
    [Serializable]
    public class ReportOrderStepsDTO
    {
        private string _GID;
        ...
        public decimal? MATERIAL_CAN_FINISH { get => _MATERIAL_CAN_FINISH; set => _MATERIAL_CAN_FINISH = value; }
        ...
        public decimal? FINISH_QTY { get => _FINISH_QTY; set => _FINISH_QTY = value; }
