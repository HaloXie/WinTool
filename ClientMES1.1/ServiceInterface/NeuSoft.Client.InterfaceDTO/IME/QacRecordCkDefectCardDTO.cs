...
{
    [Serializable]
    public class QacRecordCkDefectCardDTO
    {
        private string _GID;
        ...
        public string DEFECT_LEVEL { get => _DEFECT_LEVEL; set => _DEFECT_LEVEL = value; }
        public string CODE { get => _CODE; set => _CODE = value; }
        public string NAME { get => _NAME; set => _NAME = value; }
        public string REMARKS { get => _REMARKS; set => _REMARKS = value; }
        public string IME_QC_QAC_RECORD_CKCARD_GID { get => _IME_QC_QAC_RECORD_CKCARD_GID; set => _IME_QC_QAC_RECORD_CKCARD_GID = value; }
        ...
        public string IME_QC_DEFECT_GID { get => _IME_QC_DEFECT_GID; set => _IME_QC_DEFECT_GID = value; }
