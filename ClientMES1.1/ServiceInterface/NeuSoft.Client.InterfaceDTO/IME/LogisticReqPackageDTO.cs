...
{
    public class LogisticReqPackageDTO
    {
        private string _GID;
        ...
        public string PARENT_GID { get => _PARENT_GID; set => _PARENT_GID = value; }
        public string PACKAGE_SCHEME { get => _PACKAGE_SCHEME; set => _PACKAGE_SCHEME = value; }
        public string REQ_ORG { get => _REQ_ORG; set => _REQ_ORG = value; }
        public string OFFER_ORG { get => _OFFER_ORG; set => _OFFER_ORG = value; }
        ...
        public string PACKAGE_STANDARD { get => _PACKAGE_STANDARD; set => _PACKAGE_STANDARD = value; }
        public string STANDARD_UNIT { get => _STANDARD_UNIT; set => _STANDARD_UNIT = value; }
        public string STANDARD_CAP { get => _STANDARD_CAP; set => _STANDARD_CAP = value; }
