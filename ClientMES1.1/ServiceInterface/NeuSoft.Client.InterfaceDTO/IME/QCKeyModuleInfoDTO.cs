...
{
    [Serializable]
    public class QCKeyModuleInfoDTO
    {
        private string _GID;
        ...
        public string IME_QC_KEY_MODULE_GID { get => _IME_QC_KEY_MODULE_GID; set => _IME_QC_KEY_MODULE_GID = value; }
        ...
        public string MD_MATERIEL_INFO_GID { get => _MD_MATERIEL_INFO_GID; set => _MD_MATERIEL_INFO_GID = value; }
        public string MD_MATERIEL_INFO_CODE { get => _MD_MATERIEL_INFO_CODE; set => _MD_MATERIEL_INFO_CODE = value; }
        public string MD_MATERIEL_INFO_NAME { get => _MD_MATERIEL_INFO_NAME; set => _MD_MATERIEL_INFO_NAME = value; }
        ...
        public int? BUNDLING_STATUS { get => _BUNDLING_STATUS; set => _BUNDLING_STATUS = value; }
