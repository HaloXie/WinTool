...
{
    [Serializable]
    public class QacRecordCheckCardDTO
    {
        private string _GID;
        ...
        public string CHECK_RESULT { get => _CHECK_RESULT; set => _CHECK_RESULT = value; }
        public string INDEX_TYPE { get => _INDEX_TYPE; set => _INDEX_TYPE = value; }
        public string IS_OK { get => _IS_OK; set => _IS_OK = value; }
        public string IME_QC_QAC_RECORD_GID { get => _IME_QC_QAC_RECORD_GID; set => _IME_QC_QAC_RECORD_GID = value; }
        public string IME_QC_QAC_RECORD_CODE { get => _IME_QC_QAC_RECORD_CODE; set => _IME_QC_QAC_RECORD_CODE = value; }
        ...
        public string IME_QC_QAC_BILL_DETAIL_GID { get => _IME_QC_QAC_BILL_DETAIL_GID; set => _IME_QC_QAC_BILL_DETAIL_GID = value; }
        ...
        public IEnumerable<QacRecordCkDefectCardDTO> ListQacRecordCkDefectCardDTO { get; set; }
    }
}
