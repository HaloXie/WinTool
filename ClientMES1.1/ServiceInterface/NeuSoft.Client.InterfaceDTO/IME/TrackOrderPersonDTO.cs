...
{
    [Serializable]
    public class TrackOrderPersonDTO
    {
        private string _GID;
        ...
        public string OPERATION_GID { get => _OPERATION_GID; set => _OPERATION_GID = value; }
        public string STEPS_GID { get => _STEPS_GID; set => _STEPS_GID = value; }
        ...
        public string EQUIPMENT_GID { get => _EQUIPMENT_GID; set => _EQUIPMENT_GID = value; }
        public decimal? PERSON_NUMBER { get => _PERSON_NUMBER; set => _PERSON_NUMBER = value; }
        public decimal? PERSON_CAPACITY_EFFECTIVE { get => _PERSON_CAPACITY_EFFECTIVE; set => _PERSON_CAPACITY_EFFECTIVE = value; }
        public decimal? TOTAL_EFFECTIVE { get => _TOTAL_EFFECTIVE; set => _TOTAL_EFFECTIVE = value; }
