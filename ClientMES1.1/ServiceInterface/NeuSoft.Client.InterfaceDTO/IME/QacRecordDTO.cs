...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class QacRecordDTO
    {
        ...
        public decimal? QC_INSPECTION_QTY { get => _QC_INSPECTION_QTY; set => _QC_INSPECTION_QTY = value; }
        public string QC_INSPECTION_PERSON_GID { get => _QC_INSPECTION_PERSON_GID; set => _QC_INSPECTION_PERSON_GID = value; }
        public string MD_FACTORY_WORK_STATION_GID { get => _MD_FACTORY_WORK_STATION_GID; set => _MD_FACTORY_WORK_STATION_GID = value; }
        public DateTime? QC_INSPECTION_TIME { get => _QC_INSPECTION_TIME; set => _QC_INSPECTION_TIME = value; }
        public string QC_HANDLE_WAY { get => _QC_HANDLE_WAY; set => _QC_HANDLE_WAY = value; }
        public string REMARKS { get => _REMARKS; set => _REMARKS = value; }
        public string IME_QC_QAC_BILL_GID { get => _IME_QC_QAC_BILL_GID; set => _IME_QC_QAC_BILL_GID = value; }
        public string IME_QC_QAC_BILL_CODE { get => _IME_QC_QAC_BILL_CODE; set => _IME_QC_QAC_BILL_CODE = value; }
        ...
        public string IME_QC_QUALITY_GRADE_GID { get => _IME_QC_QUALITY_GRADE_GID; set => _IME_QC_QUALITY_GRADE_GID = value; }
        ...
        public IEnumerable<QacRecordCheckCardDTO> ListQacRecordCheckCardDTO { get; set; }
    }
}
