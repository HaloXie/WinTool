...
{
    public class LogisticReceiveDetailDTO
    {
        private string _GID;
        ...
        public string IME_LOGISTICS_RECEIVE_GID { get => _IME_LOGISTICS_RECEIVE_GID; set => _IME_LOGISTICS_RECEIVE_GID = value; }
        public string ENTRY_WAY { get => _ENTRY_WAY; set => _ENTRY_WAY = value; }
        ...
        public decimal? RECEIVE_NUM { get => _RECEIVE_NUM; set => _RECEIVE_NUM = value; }
