...
{
    [Serializable]
    public class WorkSerialManagerDTO
    {
        private string _GID;
        ...
        public string SERIAL_CODE { get => _SERIAL_CODE; set => _SERIAL_CODE = value; }
        public string SERIAL_TYPE { get => _SERIAL_TYPE; set => _SERIAL_TYPE = value; }
