...
{
    [Serializable]
    public class FactoryWorkUnitDTO
    {
        private string _GID;
        ...
        public string WORK_UNIT_CODE { get => _WORK_UNIT_CODE; set => _WORK_UNIT_CODE = value; }
        public string WORK_UNIT_NAME { get => _WORK_UNIT_NAME; set => _WORK_UNIT_NAME = value; }
