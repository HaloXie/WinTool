...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class WarehouseDTO
    {
        ...
        public string PARENT_WAREHOUSE_GID { get => _PARENT_WAREHOUSE_GID; set => _PARENT_WAREHOUSE_GID = value; }
        ...
        public string WORK_STATION_GID { get => _WORK_STATION_GID; set => _WORK_STATION_GID = value; }
        public string WAREHOUSE_TYPE { get => _WAREHOUSE_TYPE; set => _WAREHOUSE_TYPE = value; }
        public decimal? MANAGER { get => _MANAGER; set => _MANAGER = value; }
