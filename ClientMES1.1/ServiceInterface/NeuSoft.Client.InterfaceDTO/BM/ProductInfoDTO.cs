...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class ProductInfoDTO
    {
        ...
        public string BOM_TYPE { get => _BOM_TYPE; set => _BOM_TYPE = value; }
        public string REPLACE_BOM { get => _REPLACE_BOM; set => _REPLACE_BOM = value; }
        public string ROUTE_PATH { get => _ROUTE_PATH; set => _ROUTE_PATH = value; }
        public decimal? BASE_QUANTITY { get => _BASE_QUANTITY; set => _BASE_QUANTITY = value; }
        public string VERSION { get => _VERSION; set => _VERSION = value; }
        public string VERSION_DESCRIPTION { get => _VERSION_DESCRIPTION; set => _VERSION_DESCRIPTION = value; }
        public decimal? VIRTUAL { get => _VIRTUAL; set => _VIRTUAL = value; }
        ...
        public IEnumerable<ProductDetailDTO> ListProductDetailDTO { get; set; }
    }
}
