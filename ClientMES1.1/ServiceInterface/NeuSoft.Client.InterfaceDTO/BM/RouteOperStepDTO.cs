...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class RouteOperStepDTO
    {
        ...
        public string BM_ROUTE_GID { get => _BM_ROUTE_GID; set => _BM_ROUTE_GID = value; }
        public string BM_OPERATION_GID { get => _BM_OPERATION_GID; set => _BM_OPERATION_GID = value; }
        public string BM_STEP_GID { get => _BM_STEP_GID; set => _BM_STEP_GID = value; }
        public decimal? STEP_RHYTHM { get => _STEP_RHYTHM; set => _STEP_RHYTHM = value; }
        public string STEP_RHYTHM_TYPE { get => _STEP_RHYTHM_TYPE; set => _STEP_RHYTHM_TYPE = value; }
        public string STEP_TYPE { get => _STEP_TYPE; set => _STEP_TYPE = value; }
        public string BM_WORK_CENTER_GID { get => _BM_WORK_CENTER_GID; set => _BM_WORK_CENTER_GID = value; }
        public string BM_WORK_LINE_GID { get => _BM_WORK_LINE_GID; set => _BM_WORK_LINE_GID = value; }
        public string BM_WORK_UNIT_GID { get => _BM_WORK_UNIT_GID; set => _BM_WORK_UNIT_GID = value; }
        public string BM_WORK_STATION_GID { get => _BM_WORK_STATION_GID; set => _BM_WORK_STATION_GID = value; }
