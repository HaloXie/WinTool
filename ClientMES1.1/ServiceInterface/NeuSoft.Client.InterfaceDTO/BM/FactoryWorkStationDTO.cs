...
{
    [Serializable]
    public class FactoryWorkStationDTO
    {
        private string _GID;
        ...
        public string STATION_CODE { get => _STATION_CODE; set => _STATION_CODE = value; }
        public string STATION_NAME { get => _STATION_NAME; set => _STATION_NAME = value; }
        public string STATION_FUNCTION { get => _STATION_FUNCTION; set => _STATION_FUNCTION = value; }
        public string FACTORY_BUSI_UNIT_GID { get => _FACTORY_BUSI_UNIT_GID; set => _FACTORY_BUSI_UNIT_GID = value; }
        ...
        public string BM_CALENDAR_GID { get => _BM_CALENDAR_GID; set => _BM_CALENDAR_GID = value; }
