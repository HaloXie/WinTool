...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class ProductDetailDTO
    {
        ...
        public string PARENT_MATERIAL_GID { get => _PARENT_MATERIAL_GID; set => _PARENT_MATERIAL_GID = value; }
        public string MATERIAL_UNIT { get => _MATERIAL_UNIT; set => _MATERIAL_UNIT = value; }
        public decimal? BOM_NUMBER { get => _BOM_NUMBER; set => _BOM_NUMBER = value; }
        ...
        public string SUB_TECHNICS_GID { get => _SUB_TECHNICS_GID; set => _SUB_TECHNICS_GID = value; }
        public decimal? REVIEW { get => _REVIEW; set => _REVIEW = value; }
        public DateTime? VALID_BEGIN_TIME { get => _VALID_BEGIN_TIME; set => _VALID_BEGIN_TIME = value; }
        public DateTime? VALID_END_TIME { get => _VALID_END_TIME; set => _VALID_END_TIME = value; }
        public string DOSAGE_SCHEME { get => _DOSAGE_SCHEME; set => _DOSAGE_SCHEME = value; }
        public decimal? DENO_NUMBER { get => _DENO_NUMBER; set => _DENO_NUMBER = value; }
        public decimal? MOLECULE_NUMBER { get => _MOLECULE_NUMBER; set => _MOLECULE_NUMBER = value; }
        public decimal? USE_NUMBER { get => _USE_NUMBER; set => _USE_NUMBER = value; }
        public decimal? LOSS_RATE { get => _LOSS_RATE; set => _LOSS_RATE = value; }
        public string PICK_WAY { get => _PICK_WAY; set => _PICK_WAY = value; }
        ...
        public decimal? PIVOTAL { get => _PIVOTAL; set => _PIVOTAL = value; }
