...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class MaterialUnitDTO
    {
        ...
        public string ENGLISH_NAME { get => _ENGLISH_NAME; set => _ENGLISH_NAME = value; }
        public string TYPE { get => _TYPE; set => _TYPE = value; }
        public decimal? BASIC_UNIT { get => _BASIC_UNIT; set => _BASIC_UNIT = value; }
        public decimal? CONVERSION_FACTOR { get => _CONVERSION_FACTOR; set => _CONVERSION_FACTOR = value; }
        public decimal? DECIMAL_DIGIT { get => _DECIMAL_DIGIT; set => _DECIMAL_DIGIT = value; }
