...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class RouteOperationDTO
    {
        ...
        public string MD_DEF_OPERATION_GID { get => _MD_DEF_OPERATION_GID; set => _MD_DEF_OPERATION_GID = value; }
        ...
        public decimal? SORT_NUM { get => _SORT_NUM; set => _SORT_NUM = value; }
        ...
        public IEnumerable<RouteOperStepDTO> ListRouteOperStepDTO { get; set; }
    }
}
