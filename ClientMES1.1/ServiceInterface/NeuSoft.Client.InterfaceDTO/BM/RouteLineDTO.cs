...
namespace NeuSoft.Client.InterfaceDTO
{
    ...
    public class RouteLineDTO
    {
        ...
        public decimal? OUTPUT_NUM { get => _OUTPUT_NUM; set => _OUTPUT_NUM = value; }
        public decimal? RHYTHM { get => _RHYTHM; set => _RHYTHM = value; }
        public string WORK_MODE { get => _WORK_MODE; set => _WORK_MODE = value; }
        public string TRACK_ORDER_MODE { get => _TRACK_ORDER_MODE; set => _TRACK_ORDER_MODE = value; }
        public string PRODUCT_VERSION { get => _PRODUCT_VERSION; set => _PRODUCT_VERSION = value; }
        public string PRODUCT_INFO_GID { get => _PRODUCT_INFO_GID; set => _PRODUCT_INFO_GID = value; }
        public decimal? PRODUCE_CYCLE { get => _PRODUCE_CYCLE; set => _PRODUCE_CYCLE = value; }
        public string TIME_TYPE_PRODUCE_CYCLE { get => _TIME_TYPE_PRODUCE_CYCLE; set => _TIME_TYPE_PRODUCE_CYCLE = value; }
        public string TIME_TYPE_RHYTHM { get => _TIME_TYPE_RHYTHM; set => _TIME_TYPE_RHYTHM = value; }
        public decimal? RHYTHM_COUNT { get => _RHYTHM_COUNT; set => _RHYTHM_COUNT = value; }
        public decimal? PRODUCE_CYCLE_COUNT { get => _PRODUCE_CYCLE_COUNT; set => _PRODUCE_CYCLE_COUNT = value; }
        public string CLASSIFY { get => _CLASSIFY; set => _CLASSIFY = value; }
        ...
        public IEnumerable<RouteOperationDTO> ListRouteOperationDTO { get; set; }
    }
}
