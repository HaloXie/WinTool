...
{
    [Serializable]
    public class FactoryWorkCenterDTO
    {
        private string _GID;
        ...
        public string WORK_CENTER_CODE { get => _WORK_CENTER_CODE; set => _WORK_CENTER_CODE = value; }
        public string WORK_CENTER_NAME { get => _WORK_CENTER_NAME; set => _WORK_CENTER_NAME = value; }
