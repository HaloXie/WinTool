...
{
    /// <summary>
    /// 实体类IME_QC_QAC_RECORD 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public class IME_QC_QAC_RECORD : Entity
    {
        public IME_QC_QAC_RECORD() : base("IME_QC_QAC_RECORD") { }
        ...
        private decimal? _QC_INSPECTION_QTY;
        private string _QC_INSPECTION_PERSON_GID;
        private string _MD_FACTORY_WORK_STATION_GID;
        private DateTime? _QC_INSPECTION_TIME;
        private string _QC_HANDLE_WAY;
        ...
        private string _IME_QC_QUALITY_GRADE_GID;
        ...
        /// 
        /// </summary>
        public decimal? QC_INSPECTION_QTY
        {
            get { return _QC_INSPECTION_QTY; }
            set
            {
                this.OnPropertyValueChange(_.QC_INSPECTION_QTY, _QC_INSPECTION_QTY, value);
                this._QC_INSPECTION_QTY = value;
            }
        }
        /// <summary>
        /// 
        /// </summary>
        public string QC_INSPECTION_PERSON_GID
        {
            get { return _QC_INSPECTION_PERSON_GID; }
            set
            {
                this.OnPropertyValueChange(_.QC_INSPECTION_PERSON_GID, _QC_INSPECTION_PERSON_GID, value);
                this._QC_INSPECTION_PERSON_GID = value;
            }
        }
        /// <summary>
        /// 
        ...
        /// 
        /// </summary>
        public DateTime? QC_INSPECTION_TIME
        {
            get { return _QC_INSPECTION_TIME; }
            set
            {
                this.OnPropertyValueChange(_.QC_INSPECTION_TIME, _QC_INSPECTION_TIME, value);
                this._QC_INSPECTION_TIME = value;
            }
        }
        /// <summary>
        /// 
        /// </summary>
        public string QC_HANDLE_WAY
        {
            get { return _QC_HANDLE_WAY; }
            set
            {
                this.OnPropertyValueChange(_.QC_HANDLE_WAY, _QC_HANDLE_WAY, value);
                this._QC_HANDLE_WAY = value;
            }
        }
        /// <summary>
        /// 
        ...
        /// 
        /// </summary>
        public string IME_QC_QUALITY_GRADE_GID
        {
            get { return _IME_QC_QUALITY_GRADE_GID; }
            set
            {
                this.OnPropertyValueChange(_.IME_QC_QUALITY_GRADE_GID, _IME_QC_QUALITY_GRADE_GID, value);
                this._IME_QC_QUALITY_GRADE_GID = value;
            }
        }
        /// <summary>
        /// 
        ...
        public override Field[] GetFields()
        {
            return new Field[] {
                ...
                _.QC_DISPATCHED_QTY,
                _.QC_INSPECTION_QTY,
                _.QC_INSPECTION_PERSON_GID,
                _.MD_FACTORY_WORK_STATION_GID,
                _.QC_INSPECTION_TIME,
                _.QC_HANDLE_WAY,
                _.REMARKS,
        ...
        public override object[] GetValues()
        {
            return new object[] {
                ...
                this._QC_INSPECTION_QTY,
                this._QC_INSPECTION_PERSON_GID,
                this._MD_FACTORY_WORK_STATION_GID,
                this._QC_INSPECTION_TIME,
                this._QC_HANDLE_WAY,
                this._REMARKS,
                ...
                this._IME_QC_QUALITY_GRADE_GID,
                this._CREATE_BY,
                this._CREATE_TIME,
                this._UPDATE_BY,
                this._UPDATE_TIME,
        ...
        public override void SetPropertyValues(IDataReader reader)
        {
            ...
            this._QC_INSPECTION_QTY = DataUtils.ConvertValue<decimal?>(reader["QC_INSPECTION_QTY"]);
            this._QC_INSPECTION_PERSON_GID = DataUtils.ConvertValue<string>(reader["QC_INSPECTION_PERSON_GID"]);
            this._MD_FACTORY_WORK_STATION_GID = DataUtils.ConvertValue<string>(reader["MD_FACTORY_WORK_STATION_GID"]);
            this._QC_INSPECTION_TIME = DataUtils.ConvertValue<DateTime?>(reader["QC_INSPECTION_TIME"]);
            this._QC_HANDLE_WAY = DataUtils.ConvertValue<string>(reader["QC_HANDLE_WAY"]);
            ...
            this._IME_QC_QUALITY_GRADE_GID = DataUtils.ConvertValue<string>(reader["IME_QC_QUALITY_GRADE_GID"]);
        ...
        public override void SetPropertyValues(DataRow row)
        {
            ...
            this._QC_INSPECTION_QTY = DataUtils.ConvertValue<decimal?>(row["QC_INSPECTION_QTY"]);
            this._QC_INSPECTION_PERSON_GID = DataUtils.ConvertValue<string>(row["QC_INSPECTION_PERSON_GID"]);
            this._MD_FACTORY_WORK_STATION_GID = DataUtils.ConvertValue<string>(row["MD_FACTORY_WORK_STATION_GID"]);
            this._QC_INSPECTION_TIME = DataUtils.ConvertValue<DateTime?>(row["QC_INSPECTION_TIME"]);
            this._QC_HANDLE_WAY = DataUtils.ConvertValue<string>(row["QC_HANDLE_WAY"]);
            ...
            this._IME_QC_QUALITY_GRADE_GID = DataUtils.ConvertValue<string>(row["IME_QC_QUALITY_GRADE_GID"]);
        ...
        public class _
        {
            ...
            /// * 
            /// </summary>
            public readonly static Field All = new Field("*", "IME_QC_QAC_RECORD");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field GID = new Field("GID", "IME_QC_QAC_RECORD", "GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field CODE = new Field("CODE", "IME_QC_QAC_RECORD", "CODE");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field MD_PRODUCT_INFO_GID = new Field("MD_PRODUCT_INFO_GID", "IME_QC_QAC_RECORD", "MD_PRODUCT_INFO_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field QC_DISPATCHED_QTY = new Field("QC_DISPATCHED_QTY", "IME_QC_QAC_RECORD", "QC_DISPATCHED_QTY");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field QC_INSPECTION_QTY = new Field("QC_INSPECTION_QTY", "IME_QC_QAC_RECORD", "QC_INSPECTION_QTY");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field QC_INSPECTION_PERSON_GID = new Field("QC_INSPECTION_PERSON_GID", "IME_QC_QAC_RECORD", "QC_INSPECTION_PERSON_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field MD_FACTORY_WORK_STATION_GID = new Field("MD_FACTORY_WORK_STATION_GID", "IME_QC_QAC_RECORD", "MD_FACTORY_WORK_STATION_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field QC_INSPECTION_TIME = new Field("QC_INSPECTION_TIME", "IME_QC_QAC_RECORD", "QC_INSPECTION_TIME");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field QC_HANDLE_WAY = new Field("QC_HANDLE_WAY", "IME_QC_QAC_RECORD", "QC_HANDLE_WAY");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field REMARKS = new Field("REMARKS", "IME_QC_QAC_RECORD", "REMARKS");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field IME_QC_QAC_BILL_GID = new Field("IME_QC_QAC_BILL_GID", "IME_QC_QAC_RECORD", "IME_QC_QAC_BILL_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field IME_QC_QAC_BILL_CODE = new Field("IME_QC_QAC_BILL_CODE", "IME_QC_QAC_RECORD", "IME_QC_QAC_BILL_CODE");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field IME_QC_QAC_GID = new Field("IME_QC_QAC_GID", "IME_QC_QAC_RECORD", "IME_QC_QAC_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field IME_QC_QAC_CODE = new Field("IME_QC_QAC_CODE", "IME_QC_QAC_RECORD", "IME_QC_QAC_CODE");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field IME_QC_QUALITY_GRADE_GID = new Field("IME_QC_QUALITY_GRADE_GID", "IME_QC_QAC_RECORD", "IME_QC_QUALITY_GRADE_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field CREATE_BY = new Field("CREATE_BY", "IME_QC_QAC_RECORD", "CREATE_BY");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "IME_QC_QAC_RECORD", "CREATE_TIME");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UPDATE_BY = new Field("UPDATE_BY", "IME_QC_QAC_RECORD", "UPDATE_BY");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UPDATE_TIME = new Field("UPDATE_TIME", "IME_QC_QAC_RECORD", "UPDATE_TIME");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field IS_DELETE = new Field("IS_DELETE", "IME_QC_QAC_RECORD", "IS_DELETE");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field IS_ACTIVE = new Field("IS_ACTIVE", "IME_QC_QAC_RECORD", "IS_ACTIVE");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field SM_BUSI_GROUP_GID = new Field("SM_BUSI_GROUP_GID", "IME_QC_QAC_RECORD", "SM_BUSI_GROUP_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field SM_BUSI_UNIT_GID = new Field("SM_BUSI_UNIT_GID", "IME_QC_QAC_RECORD", "SM_BUSI_UNIT_GID");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field VERSION_NUM = new Field("VERSION_NUM", "IME_QC_QAC_RECORD", "VERSION_NUM");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA1 = new Field("UDA1", "IME_QC_QAC_RECORD", "UDA1");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA2 = new Field("UDA2", "IME_QC_QAC_RECORD", "UDA2");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA3 = new Field("UDA3", "IME_QC_QAC_RECORD", "UDA3");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA4 = new Field("UDA4", "IME_QC_QAC_RECORD", "UDA4");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA5 = new Field("UDA5", "IME_QC_QAC_RECORD", "UDA5");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA6 = new Field("UDA6", "IME_QC_QAC_RECORD", "UDA6");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA7 = new Field("UDA7", "IME_QC_QAC_RECORD", "UDA7");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA8 = new Field("UDA8", "IME_QC_QAC_RECORD", "UDA8");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA9 = new Field("UDA9", "IME_QC_QAC_RECORD", "UDA9");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA10 = new Field("UDA10", "IME_QC_QAC_RECORD", "UDA10");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA11 = new Field("UDA11", "IME_QC_QAC_RECORD", "UDA11");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA12 = new Field("UDA12", "IME_QC_QAC_RECORD", "UDA12");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA13 = new Field("UDA13", "IME_QC_QAC_RECORD", "UDA13");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA14 = new Field("UDA14", "IME_QC_QAC_RECORD", "UDA14");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA15 = new Field("UDA15", "IME_QC_QAC_RECORD", "UDA15");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA16 = new Field("UDA16", "IME_QC_QAC_RECORD", "UDA16");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA17 = new Field("UDA17", "IME_QC_QAC_RECORD", "UDA17");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA18 = new Field("UDA18", "IME_QC_QAC_RECORD", "UDA18");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA19 = new Field("UDA19", "IME_QC_QAC_RECORD", "UDA19");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field UDA20 = new Field("UDA20", "IME_QC_QAC_RECORD", "UDA20");
            /// <summary>
            /// 
            /// </summary>
            public readonly static Field MD_MATERIAL_GID = new Field("MD_MATERIAL_GID", "IME_QC_QAC_RECORD", "MD_MATERIAL_GID");
        }
        #endregion
